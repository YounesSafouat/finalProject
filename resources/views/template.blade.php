...
<html lang="en">
  <head>
    ...
    <link
      id="pagestyle"
      href='{{url("../assets/css/corporate-ui-dashboard.css?v=1.0.0")}}'
      rel="stylesheet"
    />
  </head>
    ...
    >
      <div class="sidenav-header">
        ...
        <a
          ...
          target="_blank"
        >
          <span class="font-weight-bold text-lg">Yo-courses</span>
        </a>
      </div>
      <div
      ...
      >
        <ul class="navbar-nav">
          <li class="nav-item">
            <a class= @yield('active1') href="{{route('allCourse',$user_id)}}">
              <div
              ...
              <span class="nav-link-text ms-1">All Coursses</span>
            </a>
          </li>
          <li class="nav-item">
            <a class=@yield('active2') href="{{route('myCourses',$user_id)}}">
              <div
                class="icon icon-shape icon-sm px-0 text-center d-flex align-items-center justify-content-center"
              >
                <svg
          ...
          <li class="nav-item">
            <a class=@yield('active3') href="{{route('payment',$user_id)}}">
              <div
                class="icon icon-shape icon-sm px-0 text-center d-flex align-items-center justify-content-center"
              >
                <svg
...
<div class="fixed-plugin">
    ...
    <div class="card shadow-lg">
      <div class="card-header pb-0 pt-3">
        <div class="float-start">
          <h5 class="mt-3 mb-0">our site Configurator</h5>
          <p>See our  options.</p>
        </div>
  ...
  <script
    src='{{url("../assets/js/plugins/swiper-bundle.min.js")}}'
